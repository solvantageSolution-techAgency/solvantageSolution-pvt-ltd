...
export default function AboutPage() {
  return (
    <section className="container-iv section-pad pt-36">
      <p className="eyebrow">About Solvantage Solution</p>
